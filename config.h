...
static unsigned int gappih    = 6;/*20;*/       /* horiz inner gap between windows */
static unsigned int gappiv    = 6;/*10;*/       /* vert inner gap between windows */
static unsigned int gappoh    = 6;/*10;*/       /* horiz outer gap between windows and screen edge */
static unsigned int gappov    = 6;/*30;*/       /* vert outer gap between windows and screen edge */
...
static const Layout layouts[] = {
	...
	{ "[deck]",	deck },			/* Master on left, slaves in monocle-like mode on right */
 	{ "[mono]",	monocle },		/* All windows on top of eachother */
...
//	{ MODKEY|ShiftMask,		XK_e,		spawn,		SHCMD(TERMINAL " -e abook -C ~/.config/abook/abookrc --datafile ~/.config/abook/addressbook") },
	...
	{ MODKEY,			XK_p,			spawn,		SHCMD("lxrandr") },
